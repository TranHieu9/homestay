                ...
                <div class="contentAboutHome">                    
                    <div class="row rowAboutHome">
                        ...
                        <div class="col-lg-6 colTextAboutHome"> 
                            <h3 class="wrapTitleType1Mini">Chào mừng đến với HomeStay</h3>

                            <h3 class="wrapTitleType1 titleMainAboutHome">Tận hưởng trọn vẹn  kì nghỉ của bạn</h3>

                            <div class="wrapTextAboutHome">
                                <p style="font-family: 'IBMPlexSerif'; font-weight: 500; font-size: 18px; line-height: 32px;">Chỉ cách thành phố 60 phút đi xe và nằm trên trung tâm đường, homestay tự tin đem đến cho bạn những trải nghiệm tuyệt vời nhất trong kì nghỉ dưỡng. Chúng tôi luôn sẵn sàng tiếp đón và phục vụ hết mình vì quý khách.</p>
