...
require_once './mvc/views/admin/RevenueChartView.php';
require_once './mvc/controlers/RevenueController.php';

if (isset($_GET['url']) && $_GET['url'] === 'admin/revenue') {
    $model = new RevenueModel();
    $view = new RevenueChartView();
    $controller = new RevenueController($model, $view);
